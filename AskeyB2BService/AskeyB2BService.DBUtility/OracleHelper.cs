...
namespace AskeyB2BService.DBUtility
{
    ...
    public abstract class OracleHelper
    {
        ...
        public static readonly string B2BConnection = ConfigurationManager.AppSettings["B2B"];
        //public static readonly string ERPConnection = ConfigurationManager.AppSettings["ERP_APPS"];
        //public static readonly string EDIConnection = ConfigurationManager.AppSettings["ERP_EDI"];
        //public static readonly string BPMDBConnection = ConfigurationManager.AppSettings["BPMDB"];
        //public static readonly string GUIDDBConnection = ConfigurationManager.AppSettings["GUIDDB"];
        ...
        public static bool ExecuteSqlTran(string conStr,List<String> SQLStringList)
        {
            using (OracleConnection conn = new OracleConnection(conStr))
            {
                ...
                {
                    LogHelper.Write("执行到第"+i.ToString()+"条,SQL:"+strErrorSql);
                    LogHelper.Write(E);
                    tx.Rollback();
                    throw new Exception(E.Message);
                }
        ...
        /// 俴嗣sqlㄛsql漪ㄛ?政岈
        /// </summary>
        /// <param name="conStr">窣諉趼睫揹</param>
        /// <param name="SqlString">sql hashtable</param>
        /// <returns></returns>
        ...
        public static OracleParameter[] GetParms(string CacheParmName)
        {
            ...
            if (parms == null)
            {
                parms = new OracleParameter[] { new OracleParameter("p_tableName",OracleDbType.Varchar2), 
                                                                    new OracleParameter("p_strWhere",OracleDbType.Varchar2),
                                                                    new OracleParameter("p_orderColumn",OracleDbType.Varchar2),
                                                                    new OracleParameter("p_orderStyle",OracleDbType.Varchar2),
                                                                    new OracleParameter("p_curPage",OracleDbType.Int32),
                                                                    new OracleParameter("p_pageSize",OracleDbType.Int32),
                                                                    new OracleParameter("p_totalRecords",OracleDbType.Int32),
                                                                    new OracleParameter("p_totalPages",OracleDbType.Int32),
